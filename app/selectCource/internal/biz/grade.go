...
func (g *GradeCase) SaveGrade(ctx context.Context, req *cv1.GradeUpdateReq) error {
	//TODO implement me
	panic("implement me")
}
...
func (g *GradeCase) Create(ctx context.Context, req *cv1.GradeReq) error {
...
func (g *GradeCase) UpdateGrade(ctx context.Context, req *cv1.GradeUpdateReq) error {
...
func (g *GradeCase) GetGradeByCurriculum(ctx context.Context, req *cv1.SingleGradeReq) (*cv1.SingleGradeReply, error) {
...
func (g *GradeCase) GetPeriodListGradeByOneTerm(ctx context.Context, req *cv1.ListPeriodGradeReq) (*cv1.ListGradeReply, error) {
	...
	res := make([]*cv1.SingleGradeReply, 0)
	for _, info := range list {
		res = append(res, &cv1.SingleGradeReply{
			Id:             info.Id,
			CurriculumId:   info.CurriculumId,
			CurriculumName: info.CurriculumName,
			Credit:         info.Credit,
	...
	return &cv1.ListGradeReply{List: res}, nil

}

func (g *GradeCase) GetGroupListGradeByCurriculum(ctx context.Context, req *cv1.ListGroupGradeReq) (*cv1.ListGradeReply, error) {
